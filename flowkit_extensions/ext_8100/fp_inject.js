    ...
    (function(){
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+5)%256;d.data[1]=(d.data[1]+3)%256;d.data[2]=(d.data[2]+10)%256;c.putImageData(d,0,0);}}}catch(e){}
        ...
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=-0.096927;};
        console.log('[SPOOF] seed=5294078 gpu=ANGLE (NVIDIA, NVIDIA GeForce ...');
    })();
