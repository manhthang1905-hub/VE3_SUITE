    ...
    (function(){
        // WebGL spoof
        var V="Google Inc. (Intel)",R="ANGLE (Intel, Intel(R) Arc(TM) A380 Direct3D11 vs_5_0 ps_5_0, D3D11)";
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+1)%256;d.data[1]=(d.data[1]+5)%256;d.data[2]=(d.data[2]+7)%256;c.putImageData(d,0,0);}}}catch(e){}
        ...
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=0.085486;};
        console.log('[SPOOF] seed=9049863 gpu=ANGLE (Intel, Intel(R) Arc(TM)...');
    })();
