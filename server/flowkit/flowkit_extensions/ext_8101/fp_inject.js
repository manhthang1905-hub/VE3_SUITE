    ...
    (function(){
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+2)%256;d.data[1]=(d.data[1]+6)%256;d.data[2]=(d.data[2]+9)%256;c.putImageData(d,0,0);}}}catch(e){}
            return otd.call(this,t);
        };
        // Hardware
        try{Object.defineProperty(navigator,'hardwareConcurrency',{get:()=>32,configurable:true});}catch(e){}
        ...
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=-0.046083;};
        console.log('[SPOOF] seed=7714884 gpu=ANGLE (AMD, AMD Radeon RX 6800...');
        // Page zoom
        (function(){
            var z='50%';
