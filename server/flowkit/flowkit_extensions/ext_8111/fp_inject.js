    ...
    (function(){
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+2)%256;d.data[1]=(d.data[1]+6)%256;d.data[2]=(d.data[2]+3)%256;c.putImageData(d,0,0);}}}catch(e){}
        ...
        // Screen
        try{Object.defineProperty(screen,'width',{get:()=>1600,configurable:true});}catch(e){}
        try{Object.defineProperty(screen,'height',{get:()=>900,configurable:true});}catch(e){}
        try{Object.defineProperty(screen,'availWidth',{get:()=>1600,configurable:true});}catch(e){}
        try{Object.defineProperty(screen,'availHeight',{get:()=>900-40,configurable:true});}catch(e){}
        // Audio
        var ogf=AnalyserNode.prototype.getFloatFrequencyData;
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=-0.087945;};
        console.log('[SPOOF] seed=7384097 gpu=ANGLE (NVIDIA, NVIDIA GeForce ...');
        // Page zoom
        (function(){
            var z='50%';
