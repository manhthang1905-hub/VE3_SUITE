    ...
    (function(){
        // WebGL spoof
        var V="Google Inc. (AMD)",R="ANGLE (AMD, AMD Radeon RX 7600 Direct3D11 vs_5_0 ps_5_0, D3D11)";
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+9)%256;d.data[1]=(d.data[1]+8)%256;d.data[2]=(d.data[2]+6)%256;c.putImageData(d,0,0);}}}catch(e){}
        ...
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=0.024503;};
        console.log('[SPOOF] seed=5508201 gpu=ANGLE (AMD, AMD Radeon RX 7600...');
        // Page zoom
        (function(){
            var z='50%';
