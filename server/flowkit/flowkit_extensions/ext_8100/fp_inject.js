    ...
    (function(){
        // WebGL spoof
        var V="Google Inc. (AMD)",R="ANGLE (AMD, AMD Radeon RX 6750 XT Direct3D11 vs_5_0 ps_5_0, D3D11)";
        ...
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=0.059496;};
        console.log('[SPOOF] seed=9298366 gpu=ANGLE (AMD, AMD Radeon RX 6750...');
        // Page zoom
        (function(){
            var z='50%';
