    ...
    (function(){
        // WebGL spoof
        var V="Google Inc. (NVIDIA)",R="ANGLE (NVIDIA, NVIDIA GeForce GTX 1650 Direct3D11 vs_5_0 ps_5_0, D3D11)";
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+5)%256;d.data[1]=(d.data[1]+9)%256;d.data[2]=(d.data[2]+10)%256;c.putImageData(d,0,0);}}}catch(e){}
        ...
        try{Object.defineProperty(screen,'availHeight',{get:()=>1080-40,configurable:true});}catch(e){}
        // Audio
        var ogf=AnalyserNode.prototype.getFloatFrequencyData;
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=0.062384;};
        console.log('[SPOOF] seed=3439968 gpu=ANGLE (NVIDIA, NVIDIA GeForce ...');
        // Page zoom
        (function(){
            var z='50%';
