    ...
    (function(){
        // WebGL spoof
        var V="Google Inc. (NVIDIA)",R="ANGLE (NVIDIA, NVIDIA GeForce RTX 3070 Ti Direct3D11 vs_5_0 ps_5_0, D3D11)";
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+9)%256;d.data[1]=(d.data[1]+10)%256;d.data[2]=(d.data[2]+2)%256;c.putImageData(d,0,0);}}}catch(e){}
            return otd.call(this,t);
        };
        // Hardware
        try{Object.defineProperty(navigator,'hardwareConcurrency',{get:()=>24,configurable:true});}catch(e){}
        ...
        try{Object.defineProperty(screen,'availHeight',{get:()=>800-40,configurable:true});}catch(e){}
        // Audio
        var ogf=AnalyserNode.prototype.getFloatFrequencyData;
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=0.035999;};
        console.log('[SPOOF] seed=8002873 gpu=ANGLE (NVIDIA, NVIDIA GeForce ...');
    })();
