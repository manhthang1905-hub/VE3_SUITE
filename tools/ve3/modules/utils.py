...
def load_settings(config_path: Path) -> Dict[str, Any]:
    ...
    settings.setdefault("flow_project_url", "")
    settings.setdefault("flow_aspect_ratio", "landscape")
    settings.setdefault("flow_delay", 3.0)
    settings.setdefault("flow_timeout", 120)
    settings.setdefault("flow_auth_auto_enabled", True)
    settings.setdefault("flow_auth_chrome_path", "")
    settings.setdefault("flow_auth_default_account", "")
    settings.setdefault("flow_accounts", [])
