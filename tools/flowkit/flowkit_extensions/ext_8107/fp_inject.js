    ...
    (function(){
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+7)%256;d.data[1]=(d.data[1]+9)%256;d.data[2]=(d.data[2]+4)%256;c.putImageData(d,0,0);}}}catch(e){}
        ...
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=0.062424;};
        console.log('[SPOOF] seed=6840678 gpu=ANGLE (NVIDIA, NVIDIA GeForce ...');
    })();
