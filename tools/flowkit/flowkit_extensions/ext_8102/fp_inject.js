    ...
    (function(){
        ...
        HTMLCanvasElement.prototype.toDataURL=function(t){
            ...
            if(d.data.length>=4){d.data[0]=(d.data[0]+7)%256;d.data[1]=(d.data[1]+8)%256;d.data[2]=(d.data[2]+7)%256;c.putImageData(d,0,0);}}}catch(e){}
        ...
        AnalyserNode.prototype.getFloatFrequencyData=function(a){ogf.call(this,a);for(var i=0;i<Math.min(a.length,10);i++)a[i]+=0.139104;};
        console.log('[SPOOF] seed=7473099 gpu=ANGLE (AMD, AMD Radeon RX 7900...');
    })();
